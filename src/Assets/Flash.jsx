...
function Flash(props) {
  return (
    <svg viewBox="0 0 512 512" width="1.5em" height="1.5em" {...props}>
      <path
        d="M392.708 179.2H275.802L384.175 8.533H247.642l-128 256h100.693L119.642 503.467 392.708 179.2z"
        fill="#ffdd09"
      />
      <path d="M281.775 8.533h-34.133l-128 256h34.133l128-256z" fill="#fff" />
      <path
        d="M350.042 179.2l-204.8 243.2-34.133 81.067L384.175 179.2h-34.133z"
        fill="#fd9808"
      />
